---
title: 'Session 7: Exploring data & making functions'
...
- [Source code of this worksheet](session7_data_exploration.Rmd) (Right-click -> download linked file)
- [Go to solution](../solution/session7_data_exploration.html)
- [The slide deck for the session](https://nyusurp.github.io/slide/session7_data_exploration.html)
