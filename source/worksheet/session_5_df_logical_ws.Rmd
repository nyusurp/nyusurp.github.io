...
- [The slide deck for the session](https://nyusurp.github.io/slide/session_5_logical_df.html)
...
Your turn: The official symbol for Vglut1 is "Slc17a7". Let's rename the row.
...
Square brackets can be used for colnames, too, and this can be useful when you need to get multiple columns by their names.
