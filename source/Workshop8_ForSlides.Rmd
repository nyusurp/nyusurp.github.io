...
author:
  - Cassandra Buzby, Yen-Chung Chen, and Eugene Plavskin
output:
  html_notebook:
    code_folding: show
    depth: 3
...
Let's use base R to plot the bill length vs bill depth for all the penguins data
```{r}
